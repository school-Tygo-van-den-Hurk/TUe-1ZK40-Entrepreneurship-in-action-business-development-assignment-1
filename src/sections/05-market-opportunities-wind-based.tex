    ...
    \subsection{Attractiveness Assessment (MON Worksheet 2)}
        ...
        \subsubsection{Challenge}
            ...
            \paragraph{Implementation obstacles: Mid}
                ...
                As mentioned above, the investment is quite large and it will require a lengthy construction period. However, the materials are not hard to acquire, and no distribution is required.
